...
if os.path.exists("urls_hybrid.txt"):
  os.remove("urls_hybrid.txt")
if os.path.exists("inverted_index_hybrid.json"):
  os.remove("inverted_index_hybrid.json")
...
with open("urls_hybrid.txt", mode="w") as file:
    file.write("\n".join(urls_crawled))

try:
    with open("inverted_index_hybrid.json", mode="r") as file:
        json_data = json.load(file)
        index = json_data["index_list"]
except IOError:
    with open("inverted_index_hybrid.json", mode="w") as file:
        new_data = {"index_list": {}}
